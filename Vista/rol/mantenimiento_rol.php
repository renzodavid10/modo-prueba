<script src="../js/rol.js?rev=<?php echo time() ///para recgar el js 
                                ?>"></script>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><b>MANTENIMIENTO ROL</b></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <h3 class="car-title"><b>LISTADO ROL</b></h3>
            <button class="btn btn-danger btn-sm float-right " onclick="abrirModalRegistroRoL()"><i class="fa fa-address-book" aria-hidden="true"></i> Nuevo Registro</button>
        </div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <label for="">Rol</label>
                            <input type="text" id="txt_rol" placeholder="Ingresar Rol" class="form-control">
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
                                    <label for="">Rol</label>
                                    <input type="text" id="txt_idRol">
                                    <input type="text" id="txt_rolEditar" placeholder="Ingresar Rol" class="form-control">
                                </div>
                                <div class="col-12">
